...
def main():
    ...
    dir_path_backups = new_directory("backups", dir_path_files)
  ...
  |,-'--|--'-.|
    ...
    if option == "1":
        ...
        generate_reports.create_reports(subfolder_reports, dir_path_reports, dir_path_devices, dir_path_backups)
